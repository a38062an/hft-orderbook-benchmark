...
\begin{figure}[htbp]
    ...
    \caption[Gateway variability excluding vector]{Gateway-mode latency standard deviation heatmap with vector excluded. Selected cells retain high coefficient of variation, so close mean values should not be over-interpreted without additional repeated-run bootstrap confidence intervals.}

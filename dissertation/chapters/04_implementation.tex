...
\texttt{CMake} build system. 
This allowed us to maintain a modular architecture while ensuring identical 
compiler flags across all variants.
...
scenarios defined in Chapter~\ref{chap:system_design}. 

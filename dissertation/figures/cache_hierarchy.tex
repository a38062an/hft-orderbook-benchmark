\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        % Annotations
        \node[anchor=west, font=\sffamily\small] at (5.4, 0) {Smallest / Fastest (Highest Financial Cost)};
        \node[anchor=west, font=\sffamily\small] at (5.4, -4.8) {Largest / Slowest (Lowest Financial Cost)};
        \draw[->, thick, dashed] (5.1, -0.4) -- (5.1, -4.4);
    \end{tikzpicture}%
    }

...
% Labels for buckets
\draw [|-|, thick, blue!80!black] ($(client.east)+(0,-0.8)$) -- node[below, font=\small\bfseries] {Net} ($(gateway.east)+(0,-0.8)$);
\draw [|-|, thick, green!60!black] ($(gateway.east)+(0,-0.8)$) -- node[below, font=\small\bfseries] {Que} ($(queue.east)+(0,-0.8)$);
\draw [|-|, thick, red!80!black] ($(queue.east)+(0,-0.8)$) -- node[below, font=\small\bfseries] {Eng} ($(engine.east)+(0,-0.8)$);

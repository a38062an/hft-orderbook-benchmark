\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        nicbox/.style={
            ...
            fill=orange!10, minimum width=3.6cm,
    ...
    % NIC box
    \node[nicbox] (nic) at (4.0, 0.8) {};
    \node[font=\sffamily\bfseries\small] at (4.0, 1.65) {Exchange NIC};
    \node[box, minimum width=2.8cm, minimum height=0.55cm]
        (ts) at (4.0, 0.95)
        {Timestamping};
    \node[box, minimum width=2.8cm, minimum height=0.55cm]
        (arb) at (4.0, 0.2)
    ...
    % Queue
    \node[queue] (q) at (7.8, 0.8) {Gateway Queue};
    ...
    % Matching Engine
    \node[engine] (me) at (11.2, 0.8) {Matching\\Engine};

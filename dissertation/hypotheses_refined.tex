...
statistically significant gains ($p < 0.05$ with Holm-Bonferroni 
correction) over the standard map, but does not reach the 
performance levels of the array where sequential searching is the 
main bottleneck.

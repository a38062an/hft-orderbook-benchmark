% Figure blocks for dissertation (canonical run: 2026-03-26)
...
\begin{figure}[htbp]
    ...
    \caption[Mixed scenario validity profile]{Mixed-scenario validity profile showing heterogeneous behavior rather than collapse into a single synthetic regime. The scenario remains suitable as a representative baseline for cross-implementation comparison.}
